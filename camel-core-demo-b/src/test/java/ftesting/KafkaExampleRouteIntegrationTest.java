...
class KafkaExampleRouteIntegrationTest {
    ...
    private static AdminClient kakfaAdminClient;
    ...
    public static void setUpBeforeClass() throws IOException {
        ...
        filePath = props.getProperty("camel.kafka-route.topic");
        fileName = props.getProperty("camel.kafka-route.topic");
    }
    ...
    public static void createKafkaAdminClient() {
        ...
        kakfaAdminClient = KafkaAdminClient.create(props);
    }

    @BeforeEach
    public void cleanTopics() {
        kakfaAdminClient.deleteTopics(List.of(topic));
    }
    ...
    void testKafkaExampleRoute() {
        ...
        assertEquals(testBody.toLowerCase(), result.toLowerCase());
    }
